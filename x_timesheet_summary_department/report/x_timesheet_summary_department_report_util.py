...
class xTimesheetSummaryDepartmentReportUtil(models.AbstractModel):
    # _name is format:
    # report.module_name.template_id
    _name = 'report.x_timesheet_summary_department.x_ts_dept_report_template'
    ...
    def render_html(self, docids, data=None):
        ...
        return Report.render(
            'x_timesheet_summary_department.x_ts_dept_report_template', docargs)
